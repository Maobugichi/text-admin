        ...
        <AnimatePresence>
         {
            ...
            (show && <motion.nav
                ...
                exit={{ x: -500}}
                className={`fixed z-20 w-[60%] md:w-[20%] md:fixed h-screen top-0 md:flex flex-col gap-5  border-r border-solid  ${theme ? 'bg-[#242424] border-blue-100' : 'bg-[#f9fbfd] border-[#5252]'}`}>
